...
namespace ReadyToUse.Board.Creation
{
    public class BoardFitter
    {
        ...
        public BoardFitter(GameSettings gameSettings)
        {
            //Variables below must be created and set in GameSettings
            // _cameraSizeOffset = gameSettings.cameraSizeOffset; //0.05f
            // _boundsOffsetFactor = gameSettings.boundsOffsetFactor; //1.15f
